...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="relative flex min-h-[100vh] shrink-0 scale-[0.65] transform flex-col items-center justify-center py-0 [perspective:800px] sm:scale-[0.75] sm:min-h-[100vh] md:scale-90 md:min-h-[200vh] lg:scale-100 md:justify-start md:py-40 lg:py-20"
    >
      <motion.h2
        style={{
        ...
        className="mb-16 text-center text-3xl font-bold text-neutral-800 dark:text-white sm:mb-20 md:mb-24 lg:mb-32"
      >
        {title || (
          <span>
...
const AceternityLogo = () => {
  return (
    <span className="text-[8px] font-bold tracking-tighter text-white/60">
      T
    </span>
  );
};
